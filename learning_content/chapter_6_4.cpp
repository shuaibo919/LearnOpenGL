...
int main()
{
    ...
    // -------------------------
    GLSingleShader shader("resource/shader/anti/anti");
    GLSingleShader screenShader("resource/shader/anti/post");
    ...
    while (!glfwWindowShouldClose(window))
    {
...

        {
            ...
            {
                ImGui::Image((ImTextureID)(intptr_t)(screenTexture), ImVec2(static_cast<float>(SCR_WIDTH / 2), static_cast<float>(SCR_HEIGHT / 2)));
            }
            ImGui::End();
        }
